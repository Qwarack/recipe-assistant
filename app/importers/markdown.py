...
class MarkdownRecipeImporter:
    ...
    def _build_recipe(
        ...
        recipe = Recipe(
            ...
            total_time_minutes=frontmatter.get(
                "preparation_time_minutes",
                frontmatter.get("total_time_minutes"),
            ),
            difficulty=frontmatter.get("difficulty", "unknown"),
            vegetarian=frontmatter.get("vegetarian"),
            vegan=frontmatter.get("vegan"),
            suitable_for_leftovers=frontmatter.get(
                "suitable_for_leftovers",
                False,
            ),
            leftover_servings=frontmatter.get("leftover_servings"),
            leftover_days=frontmatter.get("leftover_days", 1),
